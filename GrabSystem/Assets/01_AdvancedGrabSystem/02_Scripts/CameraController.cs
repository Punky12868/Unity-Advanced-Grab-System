...
public class CameraController : MonoBehaviour
{
    ...
    [SerializeField] private float walkBobFrequency = 2.5f;
    [SerializeField] private float walkBobAmplitude = 0.05f;
    [SerializeField] private float runBobFrequency = 4f;
    ...
    [SerializeField] private float randomBobMagnitude = 0.02f;
    ...
    [SerializeField] private float leanAngle = 5f;
